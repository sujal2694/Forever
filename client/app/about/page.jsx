...
const About = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className="w-[85vw] max-sm:w-full px-3 lg:w-[70vw] m-auto mt-28 fade-in">
                ...
                <div className="grid grid-cols-1 md:flex gap-5 my-10 md:h-[500px] lg:h-[700px]">
                    <div className="w-full h-full">
                        <Image className="w-full lg:w-xl h-full" src={assets.about_img} alt=""></Image>
                    </div>
                ...
                <div className="my-10">
                    ...
                    <div className="grid grid-cols-1 md:flex items-center my-10">
