...
const Qualities = () => {
  return (
    <div className="w-full">
      <div className="w-[90vw] lg:w-[80vw] m-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-5 mb-26 mt-40 ">

        <div className="flex items-center justify-center flex-col">
          <Image className="mb-5 w-14" src={assets.exchange_icon} alt=""></Image>
        ...
        <div className="flex items-center justify-center flex-col">
          <Image className="mb-5 w-14" src={assets.quality_icon} alt=""></Image>
        ...
        <div className="flex items-center justify-center flex-col">
          <Image className="mb-5 w-14" src={assets.support_img} alt=""></Image>
