  ...
  return (
    <div className="fade-in w-[90vw] lg:w-[80vw] m-auto mb-32 overflow-hidden" >
      <div className="marquee-track flex items-center gap-10 w-max py-10">
        ...
        <div className="flex items-center justify-center flex-col bg-zinc-100/50 py-10 rounded-2xl hover:shadow-quality shadow-zinc-800/20 transition-all w-[350px] duration-300">
