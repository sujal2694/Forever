...
const Qualities = () => {
  return (
    <div className="w-full fade-in">
      <div className="w-[90vw] lg:w-[80vw] m-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-1 gap-20 mb-26 mt-40 ">

        <div className="flex items-center justify-center flex-col bg-zinc-100/50 py-10 rounded-2xl hover:shadow-quality shadow-zinc-800/20 transition-all duration-300">
