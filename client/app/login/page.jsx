                ...
                <div>
                    ...
                    <form onSubmit={onLogin} className="text-center md:w-[45vw] lg:w-[20vw] my-8">
                        <div className="flex items-center justify-center flex-col gap-4">
                            {currState === "Sign Up" ? <input onChange={onchangHandler} name="name" value={data.name} className="border border-gray-700 p-3 w-full outline-none" type="text" placeholder="Name" required /> : ""}
                            {currState === "Sign Up" ? <input onChange={onchangHandler} name="number" value={data.number} className="border border-gray-700 p-3 w-full outline-none" type="text" placeholder="Phone Number" required /> : ""}
